  ...
  return (
    <div className="td-diagram">
      ...
      <svg viewBox="0 0 200 200" role="img" aria-label={`Turn direction for ${sel.name}`}>
        ...
        <ArcArrow cx={100} cy={100} r={72} startDeg={loosenCW ? 145 : 35} sweep={250} clockwise={loosenCW} className="td-loosen" width={7} />
        <ArcArrow cx={100} cy={100} r={46} startDeg={!loosenCW ? 145 : 35} sweep={250} clockwise={!loosenCW} className="td-tighten" width={9} />
      </svg>
